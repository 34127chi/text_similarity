...
def tune_hyper():
    ...
    dimensions = [low_kernel_size, high_kernel_size, num_filters, activation_func, embedding_dim]
    default_parameters = [3, 5, 256, 'relu', 128]
    ...
    def fitness(low_kernel_size, high_kernel_size, num_filters, activation_func, embedding_dim):
